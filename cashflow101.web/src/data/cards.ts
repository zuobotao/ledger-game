...
export const OPPORTUNITY_CARDS: OpportunityCard[] = [
  ...
  // 大机会 - 房地产（首付 ≥ $6,000）
  {
    ...
    type: 'real_estate',
    title: '市中心公寓',
    description: '总价 $120,000，首付 $12,000，贷款 $108,000，月净现金流 $500。',
    cost: 12000,
    cashFlow: 500,
    downPayment: 12000,
    totalValue: 120000,
  },
  {
    ...
    type: 'real_estate',
    title: '双拼别墅',
    description: '总价 $200,000，首付 $20,000，贷款 $180,000，月净现金流 $800。',
    cost: 20000,
    cashFlow: 800,
    downPayment: 20000,
    totalValue: 200000,
  ...
  // 大机会 - 企业（首付 ≥ $6,000）
  {
    ...
    type: 'business',
    title: '自动洗车店',
    description: '总价 $125,000，首付 $25,000，贷款 $100,000，月净现金流 $1,200。',
    cost: 25000,
    cashFlow: 1200,
    downPayment: 25000,
    totalValue: 125000,
  },
  {
    ...
    type: 'business',
    title: '披萨连锁店',
    description: '总价 $175,000，首付 $35,000，贷款 $140,000，月净现金流 $1,500。',
    cost: 35000,
    cashFlow: 1500,
    downPayment: 35000,
    totalValue: 175000,
  ...
  // 大机会 - 房地产
  {
    ...
    type: 'real_estate',
    title: '8户公寓楼',
    description: '总价 $800,000，首付 $80,000，贷款 $720,000，月净现金流 $2,500。',
    cost: 80000,
    cashFlow: 2500,
    downPayment: 80000,
    totalValue: 800000,
  },
  {
    ...
    type: 'real_estate',
    title: '小型写字楼',
    description: '总价 $1,500,000，首付 $150,000，贷款 $1,350,000，月净现金流 $4,500。',
    cost: 150000,
    cashFlow: 4500,
    downPayment: 150000,
    totalValue: 1500000,
  ...
  // 大机会 - 企业
  {
    ...
    type: 'business',
    title: '零部件制造厂',
    description: '总价 $1,000,000，首付 $200,000，贷款 $800,000，月净现金流 $6,000。',
    cost: 200000,
    cashFlow: 6000,
    downPayment: 200000,
    totalValue: 1000000,
  },
  {
    ...
    type: 'business',
    title: '软件公司股权',
    description: '总价 $1,500,000，首付 $300,000，贷款 $1,200,000，月净现金流 $9,000。',
    cost: 300000,
    cashFlow: 9000,
    downPayment: 300000,
    totalValue: 1500000,
...
export const TRADABLE_STOCKS: TradableStock[] = [
  { symbol: 'NOVA', name: '新星科技', basePrice: 20, sector: '科技' },
  { symbol: 'MEDX', name: '麦迪医疗', basePrice: 30, sector: '医疗' },
  { symbol: 'GRW', name: '长盛综合', basePrice: 40, sector: '综合' },
]
