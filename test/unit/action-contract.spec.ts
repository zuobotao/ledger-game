...
describe('GameAction Contract Audit', () => {
  ...
  it('should have all required action types defined', () => {
    const requiredActions = [
      ...
      'handle_payday', 'handle_charity', 'handle_child_gift', 'buy_opportunity', 'auction_opportunity',
  ...
  it('should have 29 action types total', () => {
    expect(GAME_ACTION_TYPES.length).toBe(29)
  })
  ...
  it('should require playerId for player-specific actions', () => {
    const playerSpecificActions: GameActionType[] = [
      ...
      'handle_charity', 'handle_child_gift', 'buy_opportunity', 'auction_opportunity', 'sell_opportunity', 'skip_stock_sell',
